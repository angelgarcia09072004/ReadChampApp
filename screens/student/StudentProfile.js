      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <View style={styles.whiteCard}>
            ...
            <TextInput style={styles.input} placeholder="Enter Teacher ID (Ex: READ-T-7721)" placeholderTextColor="#B0BEC5" />
            <TouchableOpacity style={styles.connectBtn}><Text style={styles.connectBtnText}>CONNECT</Text></TouchableOpacity>
          </View>
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#F5F5F5', padding: 15, borderRadius: 15, borderWidth: 2, borderColor: '#ECEFF1', marginBottom: 10 },
